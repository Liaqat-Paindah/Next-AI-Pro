  ...
  products: [
    {
      ...
      images: [
        '/sample-products/p1-1.jpg',
        '/sample-products/p1-2.jpg',
      ],
      price: 59.99,
      brand: 'Polo',
      rating: 4.5,
    ...
    },
    {
      ...
      images: [
        '/sample-products/p2-1.jpg',
        '/sample-products/p2-2.jpg',
      ],
      price: 85.9,
    ...
    },
    {
      ...
      images: [
        '/sample-products/p3-1.jpg',
        '/sample-products/p3-2.jpg',
      ],
      price: 99.95,
    ...
    },
    {
      ...
      images: [
        '/sample-products/p4-1.jpg',
        '/sample-products/p4-2.jpg',
      ],
      price: 39.95,
      brand: 'Calvin Klein',
      rating: 3.6,
    ...
    },
    {
      ...
      images: [
        '/sample-products/p5-1.jpg',
        '/sample-products/p5-2.jpg',
      ],
      price: 79.99,
      brand: 'Polo',
      rating: 4.7,
    ...
    },
    {
      ...
      images: [
        '/sample-products/p6-1.jpg',
        '/sample-products/p6-2.jpg',
      ],
      price: 99.99,
      brand: 'Polo',
      rating: 4.6,
