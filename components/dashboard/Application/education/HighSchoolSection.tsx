...
import { HighSchoolEducationProps, EducationFormData } from "@/types/application";
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FileUpload
          ...
          onFileAccepted={(file) => {
            register(`${prefix}.diplomaFile` as Path<EducationFormData>).onChange({
        ...
        <FileUpload
          ...
          onFileAccepted={(file) => {
            register(`${prefix}.transcriptFile` as Path<EducationFormData>).onChange({
