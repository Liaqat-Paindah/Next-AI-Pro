      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.h1
            ...
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4"
          >
            Our{" "}
          ...
          <motion.p
            custom={2}
            variants={textVariants}
            className="text-sm sm:text-base text-gray-600 dark:text-gray-400 max-w-3xl mx-auto font-light px-4 leading-relaxed"
          >
            Comprehensive educational services designed to guide you through every step of your academic journey. 
            From university admissions to career counseling, we provide expert support tailored to your goals.
          </motion.p>
        </motion.div>
        ...
        {/* Service Features Summary - Using Check icon instead of CheckCircle */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.6, duration: 0.6 }}
          className="mt-10 sm:mt-12 md:mt-14 flex flex-wrap justify-center gap-4 sm:gap-6"
        >
