          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 pt-12 pb-8">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-4 space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-md">
                Ayandaha Educational Consultancy Services Company empowers students 
                to achieve their international education dreams through expert guidance 
            ...
            <motion.div variants={itemVariants} className="lg:col-span-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-primary dark:text-primary text-xs">Office Address</p>
                    <p className="text-gray-900 dark:text-white text-sm">Kabul, Afghanistan</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-primary dark:text-primary text-xs">Email Us</p>
                    <a href="mailto:info@ayandaha.com" className="text-gray-900 dark:text-white text-sm hover:text-primary dark:hover:text-primary transition-colors duration-200">
                      info@ayandaha.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-primary dark:text-primary text-xs">Call Us</p>
                    <a href="tel:+93700000000" className="text-gray-900 dark:text-white text-sm hover:text-primary dark:hover:text-primary transition-colors duration-200">
                      +93 700 000 000
                    </a>
                  </div>
                </div>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center gap-3">
              ...
              <p className="text-primary dark:text-primary text-xs text-center md:text-left">
                © {currentYear} Ayandaha Educational Consultancy Services Company. All rights reserved.
              </p>
