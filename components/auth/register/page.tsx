      ...
      try {
        ...
        if (response.ok) {
          ...
          if (signInResult?.ok) {
            ...
            router.push("/dashboard/applicants/personalStep");
          }
        } else {
    ...
    <div className=" flex items-center justify-center  dark:bg-gray-900">
      <div className=" flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-120 space-y-6">
          <div className=" space-y-4 rounded-lg border dark:border-gray-600 p-8 shadow-sm">
            {/* Header */}
        ...
        {/* Registration Guide - Right Side */}
        <div className="lg:w-120 space-y-6">
          {/* Guide Card */}
          <div className="rounded-lg border dark:border-gray-600  p-6">
            ...
            <div className="space-y-6">
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Create your account first, then you can start building
                      your scholarship application profile step by step.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Provide your accurate personal details.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Add all educational levels (High School, Bachelor, Master,
                    PhD) with GPA, institution details, and upload
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Document your research articles, projects, conferences,
                    awards, and laboratory activities
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Specify your language proficiency, computer skills, and
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    List your jobs, internships, volunteer work, certificates,
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Share your study purpose, future plans, preferred fields,
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300"
              >
